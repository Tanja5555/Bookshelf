...
// Resources
    ...
    return declare([Stateful, Destroyable], {
        ...
        forceSaveProperty: function (propertyName, value) {
            // summary:
            //      Save a property value to the current version with the ForceCurrent save action.
            // propertyName: String
            //      The property name
            // value:
            //      The property value

            // Force save the given property. Then update the content model with the changes.
            return this.syncService.forceSaveProperty(propertyName, value)
                .then(this.contentModel.set.bind(this.contentModel, propertyName, value));
        },
