...
function (
    ...
    return declare([Stateful], {
        ...
        forceSaveProperty: function (propertyName, value) {
            ...
            // Save any queued properties before force saving the given property.
            return this.save()
                .then(function () {
                    this.scheduleForSync(propertyName, value);
                    return this._startSynchronizeInterval({ delay: 0, forceCurrent: true });
                }.bind(this));
        },
        ...
        _saveProperties: function (items, settings) {
            ...
            var contentLink = this.contentLink,
                properties = {},
                forceCurrent = !!settings && settings.forceCurrent,
