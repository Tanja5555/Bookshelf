...
// resources
    ...
    tinymce.addI18n({ en: lang.mixin({}, oldResources, resources) });
    ...
    return declare([_LayoutWidget, _TemplatedMixin, _HasChildDialogMixin, _UserResizable, _ValueRequiredMixin, _DndStateMixin], {
        ...
        destroy: function () {
            ...
            // When leaving edit-frame in IE(11) something breaks with the focus, causing us to lose the caret... somewhere...
        ...
        _initTinyMCE: function () {
            ...
            this._loadLegacyPlugins().then(function () {
